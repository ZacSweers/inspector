...
final class Validator_Person extends Validator<Person> {
  ...
  public Validator_Person(Inspector inspector) {
    ...
    this.aMapValidator =
        inspector.validator(Types.newParameterizedType(Map.class, String.class, String.class));
    this.favoriteFoodsValidator =
        inspector.validator(Types.newParameterizedType(Set.class, String.class));
    ...
    this.doublesOfStringsValidator =
        inspector.validator(Types.newParameterizedType(List.class, String.class));
    this.threePairsValidator =
        inspector.validator(Types.newParameterizedType(Map.class, String.class, String.class));
    this.atLeastThreeStringsValidator =
        inspector.validator(Types.newParameterizedType(Set.class, String.class));
    this.atMostThreeStringsValidator =
        inspector.validator(Types.newParameterizedType(Set.class, String.class));
  ...
  @Override public void validate(Person value) throws ValidationException {
    ...
    if (!("foo".equals(stringDefChecked) && "foo2".equals(stringDefChecked))) {
      throw new ValidationException(
          "stringDefChecked's value must be within scope of its StringDef. Is " + stringDefChecked);
    }
    ...
    // Validations contributed by "AndroidInspectorExtension"
    if (!(intDefChecked != 0)) {
      throw new ValidationException("intDefChecked's value must be within scope of its IntDef. Is "
          + intDefChecked);
    }
    ...
    if (doublesOfStringsSize % 2 != 0) {
      throw new ValidationException("doublesOfStrings's size must be a multiple of 2 but is "
          + doublesOfStringsSize);
    }
    ...
    if (atLeastThreeStringsSize < 3) {
      throw new ValidationException("atLeastThreeStrings's size must be greater than 3 but is "
          + atLeastThreeStringsSize);
    }
    ...
    if (atMostThreeStringsSize > 3) {
      throw new ValidationException("atMostThreeStrings's size must be less than 3 but is "
          + atMostThreeStringsSize);
    }
